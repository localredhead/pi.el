...
- Emacs 27.1+ (for `project.el` integration)
...
1. **Emacs `project.el`** (built-in, Emacs 27+)
...
interactive menus, mouse support, the works. It runs on **Emacs 27+**.
...
| Requirements      | Emacs 27+, vterm                          | Emacs 29+, tree-sitter, C compiler         |
...
Emacs 27–28. Choose **dnouri** if you want a richer Emacs-native UI and have
Emacs 29+.
